...
export default function PayEmiPage() {
    ...
    <div className="mx-auto max-w-xl px-4 py-12 sm:px-6">
      <div className="rounded-3xl border border-slate-200 bg-white p-6 sm:p-8 shadow-xl">
        <div className="flex items-center gap-3 mb-6">
          <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-purple-100 text-[#6320EE]">
            <CreditCard className="h-6 w-6" />
          </div>
          <div>
            <h1 className="text-xl font-black text-slate-900">
              1Fi EMI Repayment Portal
            </h1>
            <p className="text-xs text-slate-500">
              Pay your monthly 0% Mutual Fund-backed installment instantly
            </p>
          </div>
        </div>
          ...
          <form onSubmit={handleFetchBill} className="space-y-4">
            <div>
              ...
              <p className="mt-1.5 text-[11px] text-slate-400">
                Enter your 10-digit mobile number linked with CAMS/KFintech lien.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-slate-100 bg-slate-50 p-4 text-xs text-slate-600 space-y-2">
              ...
              <p className="text-[11px] text-slate-500 leading-relaxed">
                Repayments are reported immediately to your lending partner NBFC to maintain 100% investment compounding.
              </p>
            </div>
            ...
            >
              {isLoading ? (
                <span>Fetching Loan Records...</span>
              ) : (
                <>
        ...
        {step === "success" && (
          <div className="text-center space-y-4 py-4">
            ...
            <Link
              href="/"
              className="block w-full rounded-xl bg-slate-900 py-3 text-xs font-bold text-white hover:bg-slate-800 transition"
            >
              Back to Store
            </Link>
          </div>
